...
本文档是基于 [Gmsh Reference Manual](http://gmsh.info/doc/texinfo/gmsh.html) 编写的阅读笔记, 不是原文的完整翻译, 也没有严格遵循原文的结构. 部分术语保留英文是为了方便读者查询原文档.
*脚本语言定义* ([GEO 文件说明](./_GMSH/GEO.md)) 与*网格文件格式* ([MSH 文件说明](./_GMSH/MSH.md)) 是两块相对独立的内容, 因此分作两个子文件以便 Markdown 渲染器加载.
