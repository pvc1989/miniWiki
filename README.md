...
- [矢量力学](./physics/vector_mechanics.md)、[分析力学](./physics/analytical_mechanics.md)
...
- [CMU's 15-213: Introduction to Computer Systems](https://www.cs.cmu.edu/~213/)
  - [Data Lab](./programming/csapp/labs/data.md)
  - [Bomb Lab](./programming/csapp/labs/bomb.md)
  - [Attack Lab](./programming/csapp/labs/attack.md)
  - [Cache Lab](./programming/csapp/labs/cache.md)
...
- [CMU's 15-213: Introduction to Computer Systems](https://www.cs.cmu.edu/~213/)
  - [Shell Lab](./programming/csapp/labs/shell.md)
...
## 语言
- [LyX](./documenting/latex/README.md#LyX)
  - 《[数学](#数学)》《[物理](#物理)》《[算法](#算法)》含有大量数学公式，因此以 LyX 文档为主。
  - 本页内的链接指向可单独编译的分卷，不同分卷可能含有重复的章节。
  - 『顶层 `README.lyx`』大致按逻辑顺序重新编排了章节（重复的只保留一份）。
- [Markdown](./documenting/markdown.md)
  - 《[编程](#编程)》《[文档](#文档)》含有大量代码，因此以 Markdown 文档为主。
  - 本仓库已启用 [GitHub Pages](https://docs.github.com/en/pages)（[首页](https://pvc1989.github.io/miniWiki/)），目前仅支持 Markdown 文档。
